...
public class HttpsBatchMessageTest
{
    ...
    public void addMessageEncodesBodyCorrectly(
            @Mocked final HttpsSingleMessage mockMsg) throws TransportException
    {
    ...
    @Test
    public void addMessageSetsPropertiesCorrectlyWhenNoPropertiesPresent(@Mocked final HttpsSingleMessage mockMsg) throws TransportException
    {
    ...
    // Tests_SRS_HTTPSBATCHMESSAGE_11_009: [If the function throws a TransportException, the batched message shall remain as if the message was never added.]
    @Test
    ...
    // Tests_SRS_HTTPSBATCHMESSAGE_11_008: [If adding the message causes the batched message to exceed 256 kb in size, the function shall throw a TransportException.]
    // Tests_SRS_HTTPSBATCHMESSAGE_11_009: [If the function throws a TransportException, the batched message shall remain as if the message was never added.]
    @Test
